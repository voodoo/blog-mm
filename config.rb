...
set :casper, {
  blog: {
    ...
    date_format: '%d %B %Y',
    navigation: true,
    logo: 'logo.gif' # Optional
  },
  author: {
    name: 'Paul Vudmaska',
    bio: "Web developer, slacker, rock star", # Optional
    location: "San Antonio", # Optional
    website: "http://vudmaska.com", # Optional
    gravatar_email: "Paul@vudmaska.com" # Optional
  },
  navigation: {
    "Home" => "/" # tags will be added
  }
}
